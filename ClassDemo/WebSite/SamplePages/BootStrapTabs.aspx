                 ...
                 <div role="tabpanel" class="tab-pane" id="albums">
                      <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ArtistAlbumRelease_List" TypeName="ChinookSystem.BLL.AlbumController"></asp:ObjectDataSource>
                        </ContentTemplate>
                    </asp:UpdatePanel>   
                </div>
           </div>
